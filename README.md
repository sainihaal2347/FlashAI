...
Component-based UI with Hooks & Context API.

Styling

CSS3

Custom animations, gradients, and responsive flexbox/grid layouts.

Backend

Node.js & Express

RESTful API architecture handling AI requests and DB operations.

Database

MongoDB (Atlas)

NoSQL database for storing User profiles and Flashcard decks.
...
Stateless authentication and encryption.
...
Register/Login: Create an account to access your private library.

Create Deck:

Go to the Create tab.

Paste your notes (e.g., "Photosynthesis process").

Use the slider to choose the number of cards (e.g., 10).
...
Use the Arrow Buttons to navigate to the next/previous card.

Manage:

Use the Trash Icon on a deck card to delete it permanently.

Toggle Dark Mode in the Profile Dropdown -> Settings.
